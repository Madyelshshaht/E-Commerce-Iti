...
const useCategories = () => {
    ...
    const AddCategory = async (title, prefix, image) => {
        ...
        try {
            ...
            const res = await axios.post(
                `http://clicktobuy.runasp.net/api/Categories/AddCategory`,
                formData,
    ...
    const EditCategory = async (id, title, prefix, image) => {
        try {
            ...
            const res = await axios.put(
                `http://clicktobuy.runasp.net/api/Categories/${id}`,
                formData,
                { headers: { "Content-Type": "multipart/form-data", }, }
            );
    ...
    return { categories, loading, error, GetAllCategories, AddCategory, EditCategory, RemoveCategory };
}
