...
const ProductProvider = ({ children }) => {
    ...
    const UpdateProduct = async (
        ...
        try {
            ...
            console.log("Product Updated with Image:", res.data);
    ...
    const RemoveProduct = async (productId) => {
        const isConfirm = confirm("Are you sure you want Remove Product ?")
        if (!isConfirm) return;
        try {
            setLoading(true);
            const res = await axios.delete(`http://clicktobuy.runasp.net/api/Products/${productId}`);
            console.log("Prdocut Deleted Successfully:", res.data);
